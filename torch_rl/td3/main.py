...
def create_agent(env, tau, network_args, actor_optimizer_type, critic_optimizer_type,
    ...
    return TD3Agent(env.observation_space.shape, env.action_space, tau, network_args, actor_optimizer_type,
...
def run(env, n_games, tau, network_args, actor_optimizer_type, critic_optimizer_type,
        ...
        max_size=1000000, batch_size=64, policy_update_interval=2, noise_std=0.2,
        noise_clip=0.5, goal=None, assign_priority=False):
    agent = create_agent(env, tau, network_args, actor_optimizer_type,
