...
class Agent:
    def __init__(self, gamma, n_actions, input_dims,
        ...
        if self.goal is not None:
            ...
            self.actor_critic = Network(input_dims[0] + self.goal.shape[0], n_actions, fc_dims, optimizer_type,
                                        optimizer_args)
        else:
            self.actor_critic = Network(input_dims[0], n_actions, fc_dims, optimizer_type, optimizer_args)
